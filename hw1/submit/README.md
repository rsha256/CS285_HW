...
python cs285/scripts/run_hw1.py \
	...
	--video_log_freq -1 --eval_batch_size=3000
```
...
Q1.3 Hyperparameter Experimentation:
```
python cs285/scripts/run_hw1.py \
    --expert_policy_file cs285/policies/experts/Ant.pkl \
...
python cs285/scripts/run_hw1.py \
	...
	--video_log_freq -1 --eval_batch_size=3000
```
then `cd data/` run cells in `jupyter notebook data_viz.ipynb` up to Q1
...
python cs285/scripts/run_hw1.py \
	...
	--video_log_freq -1 --eval_batch_size=3000
```
then `cd data/` run remaining cells in `jupyter notebook data_viz.ipynb`
