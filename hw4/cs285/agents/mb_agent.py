...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            i_start, i_end = i * num_data_per_ens, (i + 1) * num_data_per_ens
            observations = ob_no[i_start:i_end] # TODO(Q1)
            actions = ac_na[i_start:i_end] # TODO(Q1)
            next_observations = next_ob_no[i_start:i_end] # TODO(Q1)
